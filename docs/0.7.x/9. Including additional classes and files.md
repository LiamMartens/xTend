...
<blockquote>
    ...
    <p>Multiple files can also be included at once using <pre>includeFiles</pre>. This method also expects exactly 1 parameter begin an array of paths to the respective files.</p>
    <pre>
